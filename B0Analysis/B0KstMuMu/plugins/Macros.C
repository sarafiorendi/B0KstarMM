...
// ############################
{
  ...
  if (whichVar == "FL")
      ...
      if (whichBin == -1)
	{
	  ...
	  CovHi(0,0) = 0.051*0.051 + (0.003*0.003+0.001*0.001+0.014*0.014+0.004*0.004+0.019*0.019);
	  CovHi(1,1) = 0.102*0.102 + (0.002*0.002+0.008*0.008+0.013*0.013+0.006*0.006);

	  CovLo(0,0) = 0.051*0.051 + (0.003*0.003+0.001*0.001+0.014*0.014+0.004*0.004+0.019*0.019);
      ...
      else if (whichBin == 0)
	{
	  ...
	  CovHi(0,0) = 0.101*0.101 + (0.010*0.010+0.011*0.011+0.027*0.027+0.015*0.015+0.036*0.036);
	  CovHi(1,1) = 0.000*0.000 + (0.007*0.007+0.040*0.040+0.023*0.023+0.179*0.179);

	  CovLo(0,0) = 0.090*0.090 + (0.010*0.010+0.011*0.011+0.027*0.027+0.015*0.015+0.036*0.036);
      ...
      else if (whichBin == 1)
	{
	  ...
	  CovHi(0,0) = 0.079*0.079 + (0.003*0.003+0.004*0.004+0.003*0.003+0.035*0.035);
	  CovHi(1,1) = 0.170*0.170 + (0.007*0.007+0.003*0.003+0.019*0.019+0.003*0.003);

	  CovLo(0,0) = 0.084*0.084 + (0.003*0.003+0.004*0.004+0.003*0.003+0.035*0.035);
      ...
      else if (whichBin == 2)
	{
	  ...
	  // CovHi(0,0) = 0.102*0.102 + (0.004*0.004+0.009*0.009+0.034*0.034+0.036*0.036);
	  // CovHi(1,1) = 0.060*0.060 + (0.005*0.005+0.017*0.017+0.010*0.010+0.031*0.031+0.027*0.027);

	  // CovLo(0,0) = 0.094*0.094 + (0.004*0.004+0.009*0.009+0.034*0.034+0.036*0.036);
	  // CovLo(1,1) = 0.060*0.060 + (0.005*0.005+0.017*0.017+0.010*0.010+0.031*0.031+0.027*0.027);
	  ...
	  CovHi(0,0) = 0.061*0.061;
	  CovHi(1,1) = 0.131*0.131 + (0.007*0.007+0.040*0.040+0.009*0.009+0.013*0.013+0.023*0.023);

	  CovLo(0,0) = 0.060*0.060;
	  CovLo(1,1) = 0.124*0.124 + (0.007*0.007+0.040*0.040+0.009*0.009+0.013*0.013+0.023*0.023);

	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.034*0.034+0.003*0.003+0.003*0.003+0.021*0.021) + (0.034*0.034+0.003*0.003+0.003*0.003+0.014*0.014)); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 4)
	{
	  meas[0]  = 0.392;
	  ...
	  CovHi(0,0) = 0.051*0.051 + (0.003*0.003+0.002*0.002+0.023*0.023);
	  CovHi(1,1) = 0.100*0.100 + (0.005*0.005+0.013*0.013+0.005*0.005+0.026*0.026+0.008*0.008);

	  CovLo(0,0) = 0.049*0.049 + (0.003*0.003+0.002*0.002+0.023*0.023);
      ...
      else if (whichBin == 6)
	{
	  ...
	  CovHi(0,0) = 0.049*0.049 + (0.005*0.005+0.001*0.001+0.001*0.001+0.013*0.013+0.021*0.021);
	  CovHi(1,1) = 0.120*0.120 + (0.006*0.006+0.023*0.023+0.013*0.013+0.004*0.004);

	  CovLo(0,0) = 0.056*0.056 + (0.005*0.005+0.001*0.001+0.001*0.001+0.013*0.013+0.021*0.021);
      ...
      else if (whichBin == 7)
	{
	  ...
	  CovHi(0,0) = 0.054*0.054 + (0.005*0.005+0.003*0.003+0.001*0.001+0.020*0.020);
	  CovHi(1,1) = 0.070*0.070 + (0.005*0.005+0.011*0.011+0.011*0.011+0.021*0.021);

	  CovLo(0,0) = 0.055*0.055 + (0.005*0.005+0.003*0.003+0.001*0.001+0.020*0.020);
      ...
      if (whichBin == -1)
	{
	  ...
	  CovHi(0,0) = 0.100*0.100 + (0.004*0.004+0.012*0.012+0.016*0.016+0.019*0.019+0.037*0.037);
	  CovHi(1,1) = 0.115*0.115 + (0.001*0.001+0.003*0.003+0.013*0.013+0.002*0.002);

	  CovLo(0,0) = 0.087*0.087 + (0.004*0.004+0.012*0.012+0.016*0.016+0.019*0.019+0.037*0.037);
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * (0.005*0.005+0.003*0.003+0.001*0.001+0.002*0.002); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 0)
	{
	  meas[0]  = -0.269;
	  ...
	  CovHi(0,0) = 0.174*0.174 + (0.007*0.007+0.037*0.037+0.020*0.020+0.052*0.052+0.031*0.031);
	  CovHi(1,1) = 0.280*0.280 + (0.004*0.004+0.077*0.077+0.006*0.006+0.161*0.161);

	  CovLo(0,0) = 0.400*0.400 + (0.007*0.007+0.037*0.037+0.020*0.020+0.052*0.052+0.031*0.031);
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * (0.005*0.005+0.002*0.002+0.001*0.001+0.005*0.005); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 1)
	{
	  meas[0]  = -0.123;
	  ...
	  CovHi(0,0) = 0.150*0.150 + (0.007*0.007+0.015*0.015+0.032*0.032+0.032*0.032+0.031*0.031);
	  CovHi(1,1) = 0.200*0.200 + (0.005*0.005+0.014*0.014+0.008*0.008+0.004*0.004);

	  CovLo(0,0) = 0.173*0.173 + (0.007*0.007+0.015*0.015+0.032*0.032+0.032*0.032+0.031*0.031);
      ...
      else if (whichBin == 2)
	{
	  ...
	  // CovHi(0,0) = 0.152*0.152 + (0.008*0.008+0.020*0.020+0.013*0.013+0.031*0.031);
	  // CovHi(1,1) = 0.094*0.094 + (0.018*0.018+0.008*0.008+0.031*0.031+0.005*0.005);

	  // CovLo(0,0) = 0.155*0.155 + (0.008*0.008+0.020*0.020+0.013*0.013+0.031*0.031);
	  // CovLo(1,1) = 0.097*0.097 + (0.018*0.018+0.008*0.008+0.031*0.031+0.005*0.005);
	  ...
	  CovHi(0,0) = 0.085*0.085;
	  CovHi(1,1) = 0.110*0.110 + (0.005*0.005+0.017*0.017+0.014*0.014+0.002*0.002+0.022*0.022);

	  CovLo(0,0) = 0.087*0.087;
	  CovLo(1,1) = 0.110*0.110 + (0.005*0.005+0.017*0.017+0.014*0.014+0.002*0.002+0.022*0.022);

	  // CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.008*0.008+0.002*0.002+0.001*0.001+0.001*0.001) + (0.008*0.008+0.003*0.003+0.001*0.001)); // cov[x,y] = rho * sigmax * sigmay
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.005*0.005+0.002*0.002+0.001*0.001+0.001*0.001) + (0.008*0.008+0.003*0.003+0.001*0.001)); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 4)
	{
	  meas[0]  = 0.157;
	  ...
	  CovHi(0,0) = 0.059*0.059 + (0.005*0.005+0.003*0.003+0.028*0.028+0.003*0.003);
	  CovHi(1,1) = 0.080*0.080 + (0.004*0.004+0.043*0.043+0.014*0.014+0.008*0.008+0.005*0.005);

	  CovLo(0,0) = 0.060*0.060 + (0.005*0.005+0.003*0.003+0.028*0.028+0.003*0.003);
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * (0.005*0.005+0.0003*0.0003+0.001*0.001+0.002*0.002); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 6)
	{
	  meas[0]  = 0.392;
	  ...
	  CovHi(0,0) = 0.041*0.041 + (0.005*0.005+0.002*0.002+0.006*0.006+0.020*0.020);
	  CovHi(1,1) = 0.090*0.090 + (0.003*0.003+0.014*0.014+0.011*0.011+0.038*0.038+0.017*0.017);

	  CovLo(0,0) = 0.056*0.056 + (0.005*0.005+0.002*0.002+0.006*0.006+0.020*0.020);
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * (0.005*0.005+0.002*0.002+0.001*0.001+0.001*0.001); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 7)
	{
	  meas[0]  = 0.353;
	  ...
	  CovHi(0,0) = 0.065*0.065 + (0.005*0.005+0.008*0.008+0.012*0.012);
	  CovHi(1,1) = 0.050*0.050 + (0.004*0.004+0.012*0.012+0.010*0.010+0.016*0.016+0.013*0.013);

	  CovLo(0,0) = 0.066*0.066 + (0.005*0.005+0.008*0.008+0.012*0.012);
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * (0.005*0.005+0.007*0.007+0.001*0.001); // cov[x,y] = rho * sigmax * sigmay
	}
      else { cout << "\nInvalid bin number: " << whichBin << endl; exit(EXIT_FAILURE); }
    }
  else if (whichVar == "BF")
      ...
      if (whichBin == -1)
	{
	  ...
	  // CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((4.5*4.5+0.3*0.3+3.2*3.2+1.1*1.1+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.3*0.3+3.2*3.2+1.1*1.1+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 0)
	{
	  meas[0]  = 4.64;
	  ...
	  CovHi(0,0) = 0.68*0.68 + (2.0*2.0+2.5*2.5+0.4*0.4) * meas[0]*meas[0] / 1e4;
	  CovHi(1,1) = 1.40*1.40 + (1.0*1.0+2.1*2.1+3.3*3.3+5.0*5.0) * meas[1]*meas[1] / 1e4;

	  CovLo(0,0) = 0.68*0.68 + (2.0*2.0+2.5*2.5+0.4*0.4) * meas[0]*meas[0] / 1e4;
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.2*0.2+3.2*3.2+1.5*1.5+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 1)
	{
	  meas[0]  = 3.27;
	  ...
	  CovHi(0,0) = 0.46*0.46 + (1.1*1.1+1.9*1.9+0.2*0.2) * meas[0]*meas[0] / 1e4;
	  CovHi(1,1) = 0.70*0.70 + (1.0*1.0+2.7*2.7+5.0*5.0) * meas[1]*meas[1] / 1e4;

	  CovLo(0,0) = 0.46*0.46 + (1.1*1.1+1.9*1.9+0.2*0.2) * meas[0]*meas[0] / 1e4;
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.3*0.3+3.2*3.2+2.1*2.1+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 2)
	{
	  // #######################
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.2*0.2+3.2*3.2+0.7*0.7+4.6*4.6) * meas[0]*meas[1] / 1e4 + (4.5*4.5+0.1*0.1+3.2*3.2+1.4*1.4+4.6*4.6) * meas[0]*meas[1] / 1e4); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 4)
	{
	  meas[0]  = 6.15;
	  ...
	  CovHi(0,0) = 0.43*0.43 + (0.7*0.7+3.5*3.5+4.0*4.0) * meas[0]*meas[0] / 1e4;
	  CovHi(1,1) = 0.90*0.90 + (1.0*1.0+1.0*1.0+15.2*15.2+5.0*5.0) * meas[1]*meas[1] / 1e4;

	  CovLo(0,0) = 0.43*0.43 + (0.7*0.7+3.5*3.5+4.0*4.0) * meas[0]*meas[0] / 1e4;
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((3.7*3.7+3.2*3.2+0.4*0.4+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 6)
	{
	  meas[0]  = 6.70;
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((3.8*3.8+3.2*3.2+0.2*0.2+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 7)
	{
	  meas[0]  = 4.15;
	  ...
	  // To cope with stat.com. comments
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((4.1*4.1+3.2*3.2+0.2*0.2+4.6*4.6) * meas[0]*meas[1] / 1e4) ; // cov[x,y] = rho * sigmax * sigmay
	}
      else { cout << "\nInvalid bin number: " << whichBin << endl; exit(EXIT_FAILURE); }
    }
