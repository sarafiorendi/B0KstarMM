...
// ############################
{
  ...
  if (whichVar == "FL")
      ...
      else if (whichBin == 2)
	{
	  ...
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.005*0.005+0.002*0.002+0.001*0.001+0.001*0.001) + (0.005*0.005+0.003*0.003+0.001*0.001)); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 4)
	{
	  meas[0]  = 0.157;
      ...
      else if (whichBin == 2)
	{
	  ...
	  CovHi(0,1) = CovHi(1,0) = CovLo(0,1) = CovLo(1,0) = 1. * ((0.2*0.2+3.2*3.2+0.7*0.7+4.6*4.6) * meas[0]*meas[1] / 1e4 + (0.1*0.1+3.2*3.2+1.4*1.4+4.6*4.6) * meas[0]*meas[1] / 1e4); // cov[x,y] = rho * sigmax * sigmay
	}
      else if (whichBin == 4)
	{
	  meas[0]  = 6.21;
