...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('PYTHIA6_Bd2KstarMuMu_EtaPtFilter_TuneZ2star_7TeV_cff.py'),
	annotation = cms.untracked.string('Summer12: Pythia6+EvtGen generation of B0d --> K*0(K pi) Mu+Mu-, 7TeV'))
