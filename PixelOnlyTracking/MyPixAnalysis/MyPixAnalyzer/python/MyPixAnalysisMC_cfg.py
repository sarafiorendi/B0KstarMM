...
###### Which data ######
process.load("MC_MinBias7TeV_357_TrackParticles_Skim_cff")
process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(-1))


###### Output of MyProgram ######
process.TFileService = cms.Service("TFileService",
#                                   fileName = cms.string("/afs/cern.ch/user/d/dinardo/scratch0/MyPixAnalysisOutput/MyPixAnalysisMC_Tk.root"),
                                   fileName = cms.string("MyPixAnalysisMC_Tk.root"),
