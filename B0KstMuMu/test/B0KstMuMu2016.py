...
#                         #                                                 '276317:120252455-276317:120252465',
#                                                                         '276361:515692537',
#                                                                         '276776:2211826216',
#                             ),
...
#                               'file:/gwpool/users/fiorendi/p5prime/CMSSW_8_0_24/src/B0KstarMM/B0KstMuMu/563B1859-919C-E611-ABCC-848F69FD457A.root'
                                 'root://xrootd-cms.infn.it//store/data/Run2016D/Charmonium/AOD/23Sep2016-v1/00000/CC27E614-619A-E611-9B7B-5065F3812261.root',
                                 'root://xrootd-cms.infn.it//store/data/Run2016D/Charmonium/AOD/23Sep2016-v1/00000/F0366079-7C9A-E611-8882-7845C4F914C5.root',
...
makeTrackCandidates(process,
                    ...
                    preselection = 'pt > 0.75 && abs(eta()) < 2.5', # preselection cut on candidates
                    selection    = 'pt > 0.75 && abs(eta()) < 2.5', # selection cut on candidates
